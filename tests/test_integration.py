...
def test_create_task(client):
    client.post("/register", data = {"username" : "hugoo", "password" : "Hugo@1234", "confirm" : "Hugo@1234"}, follow_redirects=True)
    client.post("/login", data = {"username" : "hugoo", "password" : "Hugo@1234"}, follow_redirects=True)
